...
void registerMaterialTypes() {
    ...
    reflect<Material>("Material")
        ...
        // The extended features (T0143) -- factors, textures and selectors,
        // one line each, which is the whole point of D23's reflection rule.
        .property<&Material::clearcoat>("clearcoat")
        .property<&Material::clearcoatRoughness>("clearcoatRoughness")
        .property<&Material::clearcoatNormalScale>("clearcoatNormalScale")
        .property<&Material::sheenColour>("sheenColour")
        .property<&Material::sheenRoughness>("sheenRoughness")
        .property<&Material::anisotropyStrength>("anisotropyStrength")
        .property<&Material::anisotropyRotation>("anisotropyRotation")
        .property<&Material::iridescence>("iridescence")
        .property<&Material::iridescenceIor>("iridescenceIor")
        .property<&Material::iridescenceThicknessMin>("iridescenceThicknessMin")
        .property<&Material::iridescenceThicknessMax>("iridescenceThicknessMax")
        .property<&Material::transmission>("transmission")
        .property<&Material::ior>("ior")
        .property<&Material::thickness>("thickness")
        .property<&Material::attenuationColour>("attenuationColour")
        .property<&Material::attenuationDistance>("attenuationDistance")
        .property<&Material::clearcoatTexture>("clearcoatTexture")
        .property<&Material::clearcoatRoughnessTexture>("clearcoatRoughnessTexture")
        .property<&Material::clearcoatNormalTexture>("clearcoatNormalTexture")
        .property<&Material::sheenColourTexture>("sheenColourTexture")
        .property<&Material::sheenRoughnessTexture>("sheenRoughnessTexture")
        .property<&Material::anisotropyTexture>("anisotropyTexture")
        .property<&Material::iridescenceTexture>("iridescenceTexture")
        .property<&Material::iridescenceThicknessTexture>("iridescenceThicknessTexture")
        .property<&Material::transmissionTexture>("transmissionTexture")
        .property<&Material::thicknessTexture>("thicknessTexture")
        .property<&Material::clearcoatUv>("clearcoatUv")
        .property<&Material::clearcoatRoughnessUv>("clearcoatRoughnessUv")
        .property<&Material::clearcoatNormalUv>("clearcoatNormalUv")
        .property<&Material::sheenColourUv>("sheenColourUv")
        .property<&Material::sheenRoughnessUv>("sheenRoughnessUv")
        .property<&Material::anisotropyUv>("anisotropyUv")
        .property<&Material::iridescenceUv>("iridescenceUv")
        .property<&Material::iridescenceThicknessUv>("iridescenceThicknessUv")
        .property<&Material::transmissionUv>("transmissionUv")
        .property<&Material::thicknessUv>("thicknessUv")
