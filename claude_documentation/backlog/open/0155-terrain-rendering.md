...
| **Order** | 464 |
| **Created** | 2026-08-06 |
| **Refs** | [../../documentation/12-vendored-capabilities.md](../../documentation/12-vendored-capabilities.md) — **read this first**, it is why this ticket exists; [0153-surface-detiling.md](0153-surface-detiling.md) — **terrain is de-tiling's worst case** and this ticket is its most demanding consumer; [0156-parallax-under-triplanar.md](../completed/0156-parallax-under-triplanar.md) — **landed 2026-08-06 for this ticket's sake**: a triplanar material with a height map marches parallax per projection, proven on a UV-less terrain heightfield, cost measured per weight configuration, and its 156.6 evaluation closed silhouette POM — so a terrain silhouette past mesh density is T0146.7's tessellation, nothing cheaper; [0154-noise-generation.md](0154-noise-generation.md) — procedural heightmaps and erosion both need it; [0086-shadows.md](0086-shadows.md) — their terrain reuses the *same* cascaded path, so this depends on it rather than duplicating it; [0088-sky-atmosphere-time-of-day.md](0088-sky-atmosphere-time-of-day.md) — the sky above it, and the sample that carries the terrain; [0045-culling-and-render-queues.md](0045-culling-and-render-queues.md) — LOD selection is queue work; [0097-texture-import-pipeline.md](0097-texture-import-pipeline.md) — heightmaps and splat masks are content; [0146-vertex-stage-hook.md](../completed/0146-vertex-stage-hook.md) — **owns tessellation (146.7)**, deferred with a trigger this ticket is the likeliest to pull; **D24**, **D26** ([../../documentation/02-decision-log.md](../../documentation/02-decision-log.md)); **T0146 closed 2026-08-07** ([../completed/0146-vertex-stage-hook.md](../completed/0146-vertex-stage-hook.md)) — the pre-rasteriser stages are the engine's, so 155.2 can now *choose* per-vertex displacement without new stage work: `IHpMaterial.vertex()` moves geometry in object space today, at the density the mesh carries. **146.7's tessellation is still deferred**, and its trigger narrowed to exactly this ticket's case — a silhouette that must change at a density the mesh does **not** carry. If 155.2 picks a clipmap or a chunked quadtree, the vertex hook may be all this needs |
