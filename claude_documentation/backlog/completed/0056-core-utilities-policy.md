...
- [ ] 56.2 Confirm the SSE/NEON paths are enabled for release builds — **moved to [T0025](../open/0025-render-layer.md)**
- [ ] 56.3 Adopt `DynamicLinearAllocator` for per-frame scratch allocations — **moved to [T0025](../open/0025-render-layer.md)**
- [ ] 56.4 Adopt `FixedBlockMemoryAllocator` where pooling pays — **moved to [T0025](../open/0025-render-layer.md)**, and it needs a profile as well as a linked library
...
**The three adoption subtasks moved to [T0025](../open/0025-render-layer.md)** rather
