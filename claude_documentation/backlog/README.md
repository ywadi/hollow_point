...
| ▶ | [T0048](inprogress/0048-hot-reloadable-gameplay-module.md) | Hot-reloadable gameplay module | 2 — Engine skeleton | ⏸ BLOCKED | High | Very Complex |
...
| ▶ | [T0129](inprogress/0129-display-modes-and-window-control.md) | Display modes: fullscreen, resolution, DPI and monitors | 4 — Render layer | 🚧 IN PROGRESS | High | Moderate |
