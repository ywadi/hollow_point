...
| [T0004](open/0004-verify-windows-host-build.md) | Verify building *on* a Windows host | 1 — Harden the build | 🔜 TODO | Medium | Moderate |
...
Current spread: 7 Trivial, 19 Simple, 33 Moderate, 25 Complex, 9 Very Complex.
