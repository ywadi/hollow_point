...
| 464 | [T0161](open/0161-game-resource-model.md) | The game resource model: a module declares its own resources, by name, at every stage | 4 — Render layer | 🔜 TODO | High | Moderate |
