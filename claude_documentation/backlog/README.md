...
| ▶ | [T0122](inprogress/0122-zig-cache-and-build-tree-host-collision.md) | `.zig-cache` and `build/` collide across hosts, the way `.harness/` used to | 1 — Harden the build | 🚧 IN PROGRESS | High | Simple |
| 2 | [T0123](open/0123-api-docs-should-not-be-hand-cranked.md) | The API reference is hand-cranked and always re-runs | 1 — Harden the build | 🔜 TODO | Medium | Simple |
...
| 270 | [T0062](open/0062-entity-behaviours.md) | Entity behaviours: attaching C++ logic to entities | 3 — Data model | 🔜 TODO | High | Very Complex |
