...
| ▶ | [T0122](inprogress/0122-zig-cache-and-build-tree-host-collision.md) | Zig cannot build from a working tree on `/mnt/c` under WSL | 1 — Harden the build | 🚧 IN PROGRESS | High | Simple |
